...
export const users = [
  ...
  { id: 2, username: "marcus-t", email: "marcus@test.com" },
  { id: 3, username: "hana-sato", email: "hana@test.com" },
  { id: 4, username: "julian-s", email: "julian@test.com" },
  { id: 5, username: "chloe-miller", email: "chloe@test.com" },
  { id: 6, username: "silas-v", email: "silas@test.com" },
  { id: 7, username: "riley-becker", email: "riley@test.com" },
  { id: 8, username: "aris-thorne", email: "aris@test.com" },
  { id: 9, username: "sarah-c", email: "sarah@test.com" },
  { id: 10, username: "leo-morales", email: "leo@test.com" },
  { id: 11, username: "beatrice-q", email: "beatrice@test.com" },
  { id: 12, username: "felix-k", email: "felix@test.com" },
];
...
export const rankings = [
  // Elena Vance
  {
    ...
    templateId: 1,
    rankedItems: [
      { movieId: 157336, tier: 0 },
      { movieId: 438631, tier: 1 },
      { movieId: 335984, tier: 1 },
      { movieId: 62, tier: 5 },
    ],
  },
  {
    ...
    templateId: 5,
    rankedItems: [
      { movieId: 391713, tier: 0 },
      { movieId: 447332, tier: 1 },
      { movieId: 120467, tier: 1 },
      { movieId: 792307, tier: 2 },
    ],
  },
  // Marcus Thorne
  {
  ...
  // Hana Sato
  {
    ...
    rankedItems: [
      { movieId: 129, tier: 0 },
      { movieId: 128, tier: 0 },
      { movieId: 508883, tier: 0 },
      { movieId: 30031, tier: 1 },
    ],
  },
  {
    userId: 3,
    templateId: 11,
    rankedItems: [
      { movieId: 496243, tier: 0 },
      { movieId: 670, tier: 0 },
      { movieId: 705996, tier: 1 },
      { movieId: 398818, tier: 1 },
    ],
  },
  // Julian Sterling
  {
  ...
  // Chloe Miller
  {
    ...
    templateId: 5,
    rankedItems: [
      { movieId: 120467, tier: 0 },
      { movieId: 447332, tier: 0 },
      { movieId: 391713, tier: 1 },
      { movieId: 792307, tier: 1 },
    ],
  },
  {
    userId: 5,
    ...
    rankedItems: [
      { movieId: 129, tier: 0 },
      { movieId: 30031, tier: 0 },
      { movieId: 508883, tier: 2 },
    ],
  },
  // Silas Vane
  {
    ...
    templateId: 6,
    rankedItems: [
      { movieId: 420617, tier: 0 },
      { movieId: 419430, tier: 0 },
      { movieId: 530385, tier: 1 },
      { movieId: 603, tier: 1 },
    ],
  },
  {
  ...
  // Riley Becker
  {
    ...
    templateId: 8,
    rankedItems: [
      { movieId: 76341, tier: 0 },
      { movieId: 245891, tier: 0 },
      { movieId: 118340, tier: 1 },
      { movieId: 155, tier: 1 },
    ],
  },
  {
    ...
    templateId: 1,
    rankedItems: [
      { movieId: 438631, tier: 0 },
      { movieId: 157336, tier: 1 },
      { movieId: 335984, tier: 2 },
    ],
  },
  // Dr. Aris Thorne
  {
    ...
    rankedItems: [
      { movieId: 424, tier: 0 },
      { movieId: 857, tier: 0 },
      { movieId: 530915, tier: 1 },
      { movieId: 872585, tier: 1 },
    ],
  },
  {
    userId: 8,
  ...
  // Leo Morales
  {
    ...
    rankedItems: [
      { movieId: 311, tier: 0 },
      { movieId: 11324, tier: 0 },
      { movieId: 44264, tier: 1 },
      { movieId: 3114, tier: 2 },
    ],
  },
  {
  ...
  // Beatrice Quinn
  {
    ...
    templateId: 11,
    rankedItems: [
      { movieId: 705996, tier: 0 },
      { movieId: 670, tier: 0 },
      { movieId: 496243, tier: 1 },
    ],
  },
  {
    userId: 11,
